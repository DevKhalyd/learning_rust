...
mod my {
    ...
    pub fn indirect_call() {
        ...
        // Ref: https://doc.rust-lang.org/std/keyword.crate.html

        /*
        crate is also used to represent the absolute path of a module, where crate refers to the root of the current crate. 
        For instance, crate::foo::bar refers to the name bar inside the module foo, from anywhere else in the same crate.
        */
        {
